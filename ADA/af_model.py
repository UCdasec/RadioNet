...
from tensorflow.keras.layers import GlobalAveragePooling1D, Dense, Activation
...
def build_embedding_DF_model(input_shape, emb_size):
    # -----------------Entry flow -----------------
...
def build_embedding_Homegrown(inp_shape, emb_size):
    # -----------------Entry flow -----------------

    from tensorflow.keras.layers import GlobalAveragePooling1D as GlobalAveragePooling
    from tensorflow.keras.layers import Conv1D as Conv
