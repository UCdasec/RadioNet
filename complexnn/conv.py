...
from tensorflow.keras.layers import Lambda, Layer, InputSpec, Conv2D
...
# from TF.cxnn.complexnn import utils
...
class ComplexConv(Layer):
    ...
    def build(self, input_shape):
        ...
        self.kernel_shape = self.kernel_size + (input_dim, self.filters * 2)
